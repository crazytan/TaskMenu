...
- The app needs outbound network access for Google OAuth, Google Tasks, token revocation, and GitHub release update checks. Mac App Store builds make no GitHub request.
