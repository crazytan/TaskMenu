...
- `TaskDetailAppKitViewController.swift` - task edit screen, title/notes fields, due-date state and calendar overlay, list picker that moves the task to another list, delete action, and subtask add/toggle UI.
